                    ...
                    <!-- <?php
						foreach($data as $key => $values){ 
							...
							<li class="comment">
								...
								<h3 name = name_cmt><?=$values["title"]?></h3>
								<div class="meta">October 03, 2018 at 2:21pm</div>
								<p name = "message_cmt"><?=$values["content"]?></p>
...
<?php
    ...
    $id = $_POST['id'];
        ...
        $sql = "INSERT INTO blog(id, image, title, content) VALUES ('$id', '$image', '$title', '$content')";
    
        if(!empty($id) && !empty($image) && !empty($title) && !empty($content)){
